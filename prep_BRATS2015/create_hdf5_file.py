...
def createHDF5File(config):
    ...
    grp.create_dataset("testing_hgglgg_patients", config['testing_hgglgg_patients_shape'], np.uint16)

    grp.create_dataset("testing_hgglgg_patients_pat_name", (config['testing_hgglgg_patients_shape'][0],), dtype="S100")
                ...
                if os.path.isdir(grade_type):
                    ...
                    if 'Testing' in dataset_splits:
                        ...
                        for images, pats in dataloader.loadDataGenerator(grade_type,
                                                            ...
                                                            preprocess=PREPROCESS_DATA, dataset='2013'):
