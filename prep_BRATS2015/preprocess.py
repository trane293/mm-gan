...
filename = os.path.join(os.sep.join(config['hdf5_filepath_prefix'].split(os.sep)[0:-1]), 'BRATS2015_Cropped_Normalized.h5')
...
new_group_preprocessed.create_dataset("testing_hgglgg_patients", config['testing_hgglgg_patients_shape_crop'], np.float32)
new_group_preprocessed.create_dataset("testing_hgglgg_patients_pat_name", (config['testing_hgglgg_patients_shape'][0],), dtype="S100")
# ====================================================================================
...
new_group_preprocessed['testing_hgglgg_patients_pat_name'][:] = hdf5_file['testing_hgglgg_patients_pat_name'][:]
...
run_on_list = ['training_data_segmasks_hgg', 'training_data_hgg', 'training_data_lgg', 'training_data_segmasks_lgg', 'testing_hgglgg_patients']
...
for run_on in run_on_list:
    ...
    elif run_on == 'testing_hgglgg_patients':
        im_np = np.empty(config['testing_hgglgg_patients_shape_crop'])
